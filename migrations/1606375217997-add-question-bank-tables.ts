...
export class AddQuestionBankTables1606375217997 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "public"."question" ("id" SERIAL NOT NULL, "question_p" character varying(256) NOT NULL, "question_n" character varying(256), "type" "question_type_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "question_bank_id" integer NOT NULL, CONSTRAINT "PK_4862ab95d7239a36a56f67bac6e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
